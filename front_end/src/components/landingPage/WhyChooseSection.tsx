...
export const WhyChooseSection = () => {
  return (
    <div id="features">
    <section className="py-3 px-3 mt-20 md:px-20 bg-transparent text-black dark:text-white">
      <div className="text-center mb-12">
        ...
        <div className="mt-2 w-16 h-1 bg-[#00B8E4] mx-auto rounded-full" />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Card 1 */}
        <div className="flex items-start gap-4 border p-6 rounded-lg shadow-sm">
