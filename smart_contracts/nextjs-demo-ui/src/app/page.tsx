      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 px-8 py-16">
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            ...
            <div className="bg-blue-600 text-white py-2 px-4 rounded-md animate-pulse">
              Loading...
            </div>
            <a 
              href="#how-it-works"
...
function StaticContent() {
  return (
    <>
      ...
      {/* SSI Registration Section */}
      <div className="px-8 py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="text-center mb-12">
        ...
        <div className="text-center">
          <Link 
            href="/regulatory"
            className="inline-flex items-center space-x-2 bg-white text-purple-600 py-2 px-4 rounded-md hover:bg-gray-100 border border-white"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.031 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            <span>Start SSI Registration</span>
          </Link>
        </div>
      </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 px-8 py-16">
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            <Link 
              href="/regulatory"
              className="flex items-center space-x-2 bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.031 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
              <span>Register with SSI</span>
            </Link>
            <Link 
              href="/regulatory"
            ...
            <a 
              href="#how-it-works"
              className="border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Learn More
            </a>
          </div>
      ...
      <div className="px-8 py-6 bg-white border-b">
        <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-600">
              Network: {networkInfo.network === 'hardhat' ? 'Local Development' : 'Fantom Sonic Testnet'}
            </span>
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono">
                  {networkInfo.network === 'hardhat' ? 'Local Development' : 'Fantom Sonic Testnet'}
                </span>
              </div>
              <div className="flex justify-between items-center">
      ...
      <div className="px-8 py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center">
        ...
        <p className="text-xl mb-8 text-blue-100">
          Start with SSI registration - no wallet connection required to begin. 
          Explore the complete decentralized equity investment ecosystem.
        </p>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link 
            href="/regulatory"
            className="flex items-center space-x-2 bg-white text-purple-600 py-2 px-4 rounded-md hover:bg-gray-100 border border-white"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.031 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          ...
          <Link 
            href="/regulatory"
            className="border border-white text-white py-2 px-4 rounded-md hover:bg-white hover:text-blue-600"
          >
            Explore Demo
          </Link>
        </div>
        <p className="text-sm text-blue-200 mt-4">
          No wallet connection required to start SSI registration
        </p>
      </div>
    </div>
  )
